...
function InvoiceCard({ isDark }) {
    return (
        <>
            <div className={`cursor-pointer h-[72px] w-[730px] mt-5 mx-auto ${isDark ? " bg-dark-blue" : " bg-white"} hover:border-primary-1 hover:border-[1px]  rounded-[8px] shadow-md md:h-[134px] md:w-[327px]`}>
                <div className='flex md:flex-col md:justify-center  my-auto pl-6 md:pl-3 px-7 gap-8 h-full'>
                    <div className='flex  md:justify-between'>
                        ...
                        <div className='flex items-center md:items-start justify-end'>
                            <h1 className='pl-10 text-center font-medium font-sans text-[13px] text-m-gray'>Youssef EL HAOUIL</h1>
                        </div>
                    </div>
                    <div className='flex  justify-end  md:justify-between items-center gap-4 ml-6 md:ml-0 '>
                        <h1 className={`font-bold font-sans text-[15px] md:pl-3 md:mt-[-40px] ${isDark ? " text-white" : "text-black"} `}>$ 1000.00 </h1>
