...
function InvoiceCard({ isDark ,filtredInvoices }) {
    ...
    const draftCard = () => {
        return (
            <span className='w-[104px] h-[40px] flex justify-center items-center gap-3 rounded font-bold text-[#373B53] bg-[#9797975a]  '>
    ...
    return (
        <>
            {
                filtredInvoices.length > 0 ? filtredInvoices.map((invoice, index) => (
                    <div
                        key={index}
